...
CREATE TABLE `events` (
  ...
  `user_id` int(11) NOT NULL,
  `scanner_id` TEXT NULL DEFAULT NULL,
  `address` varchar(255) DEFAULT NULL,
  `category_id` int(11) NOT NULL,
...
('2', 'BankPayout', current_timestamp(), current_timestamp());
...
CREATE TABLE `general_settng` (
  ...
  `verify_by` varchar(255) DEFAULT NULL COMMENT 'email,phone',
  ...
  `enable_twillio` INT NULL DEFAULT '0',
  `vonege_api_key` VARCHAR(150) NULL,
  `vonage_account_secret` VARCHAR(150) NULL,
  `vonage_sender_number` VARCHAR(150) NULL,
  `enable_vonage` INT NULL DEFAULT '0',
  `enable_google_signin` TINYINT(1) NULL DEFAULT '0',
  ...
  `appuser_privacy_policy` text DEFAULT NULL,
  ...
  `show_event_report_form` TINYINT NULL DEFAULT '1',
  `show_link_banner` INT NULL DEFAULT '1',
  `show_brands_carousel` INT NULL DEFAULT '1',
  `googleplay_link` varchar(255) NULL,
  `appstore_link` varchar(255) NULL,
  `openai_switch` TINYINT(1) NOT NULL DEFAULT '1',
  `openai_key` VARCHAR(255) NULL DEFAULT 'ENTER_YOUR_KEY_HERE',
  `openai_selected_model` VARCHAR(80) NOT NULL DEFAULT 'gpt-4.1-nano',
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `language` (
  ...
  `code` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT 'en' COMMENT 'Example: en, fr, ar',
...
CREATE TABLE `payment_setting` (
  ...
  `raveWebhookSecretHash` varchar(255) DEFAULT NULL,
...
INSERT INTO `payment_setting` (`id`, `stripe`, `cod`, `paypal`, `razor`, `flutterwave`, `stripeSecretKey`, `stripePublicKey`, `paypalClientId`, `paypalSecret`, `razorPublishKey`, `razorSecretKey`, `ravePublicKey`, `raveSecretKey`,  `raveWebhookSecretHash`, `flutterDebugMode`, `created_at`, `updated_at`) VALUES
(1, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-04-18 07:39:49', '2023-04-18 07:39:49');
...
CREATE TABLE `users` (
  ...
  `provider` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT 'LOCAL',
...
('Brand 8', 'https://example.com', NULL, 1, NOW(), NOW());
--
-- Indexes for dumped tables
--
...
VALUES
    (
        ...
        NULL,
        '1',
        '$2y$10$l84Xfp4x8hyNPwK.RqBzRuNbItCJXf7FRzHoJ.WU/VIwLQY4rNDuu',
        '1686',
        NULL,
        NULL,
        'LOCAL',
