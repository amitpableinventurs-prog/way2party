                        ...
                        <tbody>
                            @foreach ($orders as $item)
                                <tr>
                                    ...
                                    <td>{{$item->customer->name.' '.$item->customer->last_name}} <br> <a href="tel:{{$item->customer->phone}}">{{$item->customer->phone}}</a></td>
                                    @else
                                        <td></td>
                                    @endif
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            {{ Carbon\Carbon::parse($item->event->start_time)->format('d M Y') . ' To'}} <br> {{ Carbon\Carbon::parse($item->event->end_time)->format('d M Y') }}
                                        @endif
                                    </td>
                                    <td>{{$item->quantity.' ticket'}}</td>
                                    <td>{!! $item->check_in_status !!}</td>
