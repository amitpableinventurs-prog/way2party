                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" placeholder="{{__('Description')}}" class="textarea_editor form-control @error('description')? is-invalid @enderror">{{$blog->description}}</textarea>
                                    @error('description')
                                        <div class=" invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
