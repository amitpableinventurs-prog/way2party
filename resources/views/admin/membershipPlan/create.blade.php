        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{ url('membership-plan') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" value="{{ old('name') }}"
                                                        placeholder="{{ __('e.g. Silver, Gold, Platinum, Diamond') }}"
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" name="sort_order"
                                                        value="{{ old('sort_order', 0) }}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
