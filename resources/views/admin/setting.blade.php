            ...
            <div class="row">
                    ...
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse mt-3" id="payment-setting">
                                ...
                                <form id="paymentForm" method="post" action="{{ url('save-payment-setting') }}">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            ...
                                            <div class=" mt-2">
                                                <select name="flutterDebugMode" id=""
                                                    ...
                                                    <option value="1" {{ $payment->flutterDebugMode == '1' ? 'selected' : '' }}>{{ __('Yes') }}</option>
                                                    <option value="0" {{ $payment->flutterDebugMode == '0' ? 'selected' : '' }}>{{ __('No') }}</option>
                                                </select>
                                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse mt-3" id="mail-setting">
                                ...
                                <form method="post" action="{{ url('save-mail-setting') }}">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ __('Mail Encryption') }}</label>
                                        <div class="col-sm-12 col-md-9">
                                            <select required name="mail_encryption" class="form-control select2">
                                                <option value="" disabled>{{ __('Mail Encryption/Authentication') }}</option>
                                                <option value="ssl"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <select required name="mail_mailer" class="form-control select2">
                                                <option value="smtp"
                                                    {{ $setting->mail_mailer == 'smtp' || !$setting->mail_mailer ? 'selected' : '' }}>
                                                    {{ __('smtp') }}
                                                </option>
                                                <option value="mailgun"
                                                    {{ $setting->mail_encryption == 'mailgun' ? 'selected' : '' }}>
                                                    {{ __('mailgun') }}</option>
                                            </select>
                                            @error('mail_mailer')
                                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse mt-3" id="additional-setting">
                                ...
                                <form method="post" action="{{ url('additional-setting') }}">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label
                                            class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ __('Show App Link Banner') }}</label>
                                        <div class="col-sm-12 col-md-9">
                                            <div class="custom-switches-stacked mt-2">
                                                <label class="custom-switch pl-0">
                                                    <input type="checkbox" name="show_link_banner"
                                                        {{ $setting->show_link_banner == 1 ? 'checked' : '' }}
                                                        value="1" class="custom-switch-input">
                                                    <span class="custom-switch-indicator"></span>
                                                </label>
                                            </div>
                                            @error('show_link_banner')
                                                <div class="invalid-feedback block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <input type="url" name="googleplay_link"
                                                placeholder="{{ __('Customer App GooglePlay Link') }}"
                                                value="{{ $setting->googleplay_link }}"
                                                class="form-control @error('googleplay_link')? is-invalid @enderror">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label
                                            class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ __('App AppStore Link') }}</label>
                                        <div class="col-sm-12 col-md-9">
                                            <input type="url" name="appstore_link"
                                                placeholder="{{ __('Customer App AppStore Link') }}"
                                                value="{{ $setting->appstore_link }}"
                                                class="form-control @error('appstore_link')? is-invalid @enderror">
                                            @error('appstore_link')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card card-large-icons">
                            ...
                            <div class="card-body">
                                ...
                                <p>{{ __('After setting this ON, You will see the detailed error messages, System becomes vulnerable when this is ON, So Make sure you set this OFF as soon as you are done debugging, It\'s fine if you are on the local server') }}</p>
                                ...
                                <div class="collapse mt-3" id="debugMode">
                                    ...
                                    <form method="post" action="{{ url('save-debug') }}">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <label
                                                class="col-form-label col-12 col-md-4">{{ __('Debug Mode') }}</label>
                ...
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            <h4> {{__('OpenAI')}} </h4>
                            <p> {{__('OpenAI for Event Description Generation')}} </p>
                            <a data-toggle="collapse" href="#openai_settings" class="card-cta" role="button" aria-expanded="false">
                                {{__('Change Setting')}} <i class="fas fa-chevron-right"></i>
                            </a>
                            <form method="POST" action="{{url('/save-openai-setting')}}">
                                @csrf
                                <div class="collapse mt-3" id="openai_settings">
                                    <div class="form-group">
                                        <label class="custom-switch mt-2 p-0">
                                            <input type="checkbox" value="1" name="openai_switch" class="custom-switch-input form-control @error('openai_switch') is-invalid @enderror"
                                                {{$setting->openai_switch == 1 ? 'checked' : ''}}>
                                                @error('openai_switch')
                                            ...
                                            @enderror
                                            <span class="custom-switch-indicator"></span>
                                            <span class="custom-switch-description"> {{__('Use AI Feature')}} </span>
                                        </label>
                                    </div>
                                    <div class="col-12 col-md-12 col-lg-12 p-0">
                                        <div class="form-group">
                                            <label>{{ __('OpenAI API Key') }}</label>
                                                <a href="https://www.openai.com/" target="_blank"><i class="fa fa-question-circle fa-lg text-muted ml-1" data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Get Your API Key"></i></a>
                                            <input type="text" name="openai_key" class="form-control @error('openai_key') is-invalid @enderror"
                                                 placeholder="{{__('OpenAI API Key')}}" value="{{ old('openai_key',$setting->openai_key) }}">
                                            @error('openai_key')
                                                <div class="invalid-feedback display-block">
                                                    {{$message}}
                                                </div>
                                    ...
                                    <div class="col-12 col-md-12 col-lg-12 p-0">
                                        <div class="form-group">
                                            <label>{{ __('Choose AI Model') }}</label>
                                            <select name="openai_selected_model" id="openai_model_select" class="form-control @error('openai_selected_model') is-invalid @enderror" required>
                                                @php
                                                    $aiModels = [
                                                ...
                                                @foreach ($aiModels as $model)
                                                    <option value="{{ $model['value'] }}" {{ ($setting->openai_selected_model === $model['value']) ? 'selected' : '' }}>
                                                        {{ __($model['name']) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('openai_selected_model')
