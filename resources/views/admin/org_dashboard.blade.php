...
.date-left::after {
  content: "";
  position: absolute;
  bottom: -5px; /* Position slightly below the container */
  left: 50%;
                            ...
                            <div class="home-upcoming-event">
                                ...
                                @else
                                    @foreach ($monthEvent as $item)
                                        <div class="row mb-4">
                                            <div class="col-3 date-container">
                                                <div class="date-left">
                                            ...
                                            <div class="col-9 event-right">
                                                ...
                                                <p class="mb-0">Ticket Sold <span>{{ $item->sold_ticket }}/{{ $item->tickets }}</span></p>
                                                <div class="progress mb-3" data-height="5">
                                                    <div class="progress-bar" role="progressbar" data-width="{{ $item->average }}%"
                                                         aria-valuenow="{{ $item->average }}" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
