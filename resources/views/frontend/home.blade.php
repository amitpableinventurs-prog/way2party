...
@section('content')
    ...
    <div class="bg-scroll" style="background-image: url('images/Eventright Background.png')">
            ...
            <div id="default-carousel" class="relative" data-carousel="slide">
                ...
                <div class="your-carousel relative w-full mx-auto overflow-hidden h-1/2">
                    @if (count($banner) > 0)
                                ...
                                <a href="{{ url('event/' . $item->event->id . '/' . Str::slug($item->event->name)) }}">
                                    <div class="h-1/2 relative">
                                        <img src="{{ asset('/images/upload/' . $item->image) }}"
                                            ...
                                            alt="Image 1">
                                        <h1
                                            class="font-poppins font-medium leading-6 text-center absolute inset-0 flex items-center justify-center xxsm:text-2xl sm:text-5xl text-white drop-shadow-[1px_1px_1px_rgba(0,0,0,0.5)]">
                                            {{ $item->title }}</h1>
                                    </div>
                                </a>
                            </div>
                        @endforeach
                    @else
                        <div class="h-1/2 bg-primary relative xxsm:h-[200px] sm:h-1/2">
                            <div class="h-1/2 relative xxsm:h-[200px] sm:h-1/2">
                                ...
                                <a href="{{ url('event/' . $item->id . '/' . Str::slug($item->name)) }}">
                                    <div class="relative capitalize">
                                        ...
                                        @switch(strtolower($item->auto_generated_tag))
                                            @case('almost full')
                                                <span
                                                    class="bg-success text-center text-sm text-white py-1 px-2 rounded-bl-lg rounded-tr-lg absolute top-0 right-0">
                                                    {{ __($item->auto_generated_tag) }}
                                                </span>
                                            @break

                                            @case('sales ending soon')
                                                <span
                                                    class="bg-warning text-center text-sm text-white py-1 px-2 rounded-bl-lg rounded-tr-lg absolute top-0 right-0">
                                                    {{ __($item->auto_generated_tag) }}
                                                @break
        ...
        {{-- Latest blogs --}}
        <div
            class="absolute pointer-events-none bg-warning blur-3xl opacity-10 s:bg-opacity-10 3xl:w-[370px] 3xl:h-[370px] 2xl:w-[300px] 2xl:h-[300px] 1xl:w-[300px] xmd:w-[300px] xmd:h-[300px] sm:w-[200px] sm:h-[300px] xxsm:w-[300px] xxsm:h-[300px] rounded-full -mt-5 2xl:-ml-20 1xl:-ml-20 sm:ml-2 xxsm:-ml-7">
        </div>
        ...
        @if (count($blog) == 0)
            <div class="font-poppins font-medium text-lg leading-4 text-black mt-5 ml-5 mb-8 capitalize">
                    ...
                    <div
                        ...
                        <div class="ml-4 3xl:w-full xl:w-full xlg:w-full xmd:w-full xxmd:w-[80%] sm:w-1/2">
                            <div class="flex justify-between">
                                ...
                                <p
                                    class="font-poppins font-medium text-base  leading-6 text-gray xxsm:max-md:mt-5 py-1">
    ...
    @if ($showLinkBanner->show_link_banner == 1)
        <div class="w-full h-full bg-gradient-to-r from-gradient-bg1 to-gradient-bg2">
            <div class="w-full bg-cover bg-no-repeat"
                ...
                <div
                    class="xxxxl:pl-[300px] xxxxl:pr-[300px] xxxxl:pt-[116px] s:pl-[10px] s:pr-[10px] s:pt-[50px] xxl:pl-[100px] xxl:pr-[100px] xxxl:pr-[150px] xxxl:pl-[150px] p-10 ml-28 xl:p-10  xxsm:p-3 xxsm:ml-0">
    ...
    <div class="overflow-hidden mx-auto relative px-4 sm:px-6 lg:px-8 pb-[65px] xl:pb-24">
        <h2 class="font-poppins font-bold text-[18px] text-primary tracking-wider text-center my-8">
            {{ __('Well-known Organizers On-board') }}
        </h2>
        <div
