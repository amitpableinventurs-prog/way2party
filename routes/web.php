...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/save-google-signin-setting', [SettingController::class, 'saveGoogleSigninSetting']);
    Route::post('/save-openai-setting', [SettingController::class, 'openai_settings']);
    Route::post('/openai-setting-test', [SettingController::class, 'openai_test']);
    ...
    Route::get('/{eventId}/faqs', [EventFaqController::class, 'indexByEvent'])->name('event-faq.index');
    Route::get('/{eventId}/faqs/create', [EventFaqController::class, 'create'])->name('event-faq.create');
    Route::get('/{eventId}/faqs/{id}', [EventFaqController::class, 'showByEvent'])->name('event-faq.show');
    Route::post('/{eventId}/faqs', [EventFaqController::class, 'store'])->name('event-faq.store');
    Route::put('/{eventId}/faqs/{id}', [EventFaqController::class, 'update'])->name('event-faq.update');
    Route::delete('/event-faq/{id}', [EventFaqController::class, 'destroy'])->name('event-faq.destroy');
    Route::get('/event-faq/{id}/edit', [EventFaqController::class, 'edit'])->name('event-faq.edit');
    ...
    Route::post('/events/description', [EventController::class, 'generateDescription'])
        ->name('events.generateDescription');
});
